...
<meta charset="UTF-8">
<title>${title}</title>
<link rel="stylesheet" href="${contextPath}/css/login_legacy.css">
</head>
<body>
  <div class="login-bg">
    <div class="content">
      ...
      <div class="form-box">
        <form id="loginForm" action="${contextPath}/login" method="post">
          <div class="login-center">
            <span class="t-name">手机号：</span><input type="text" name="mobilePhoneNumber" id="tel_num" class="inp phone-inp" value="${mobilePhoneNumber}" placeholder="请输入您的手机号">
          </div>
          <div class="login-center">
  ...
  <script type="text/javascript" src="${contextPath}/js/login_legacy.js"></script>
</body>
</html>